...
class InspectionsController < ApplicationController
  ...
  def geoloc(lat, lng, limit)
    nearby_query = "SELECT v.venuename as name, a.lat, a.lng, a.num  || ' ' || a.streetname as address, #{distance_clause(lat,lng)} FROM addresses a INNER JOIN venues v ON v.address_id=a.id ORDER BY distance ASC LIMIT #{limit}"
